import { BaseLiveView, LiveViewMountParams, LiveViewSocket, SessionData, html, LiveViewMeta } from "liveviewjs";
...
type Events = { type: "update"; photoSizeIndex: string };

export class PrintsLiveView extends BaseLiveView<Context, Events> {
