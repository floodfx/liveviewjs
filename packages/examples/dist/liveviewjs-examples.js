...
class LicenseLiveView extends liveviewjs.BaseLiveView {
    mount(params, session, socket) {
        const seats = 2;
...
class LightLiveView extends liveviewjs.BaseLiveView {
    mount(params, session, socket) {
...
class SalesDashboardLiveView extends liveviewjs.BaseLiveView {
    mount(params, session, socket) {
        if (socket.connected) {
            socket.repeat(() => {
...
exports.LicenseLiveView = LicenseLiveView;
exports.LightLiveView = LightLiveView;
exports.PaginateLiveView = PaginateLiveView;
exports.SalesDashboardLiveView = SalesDashboardLiveView;
