...
class NodeExpressLiveViewServer {
    ...
    httpMiddleware() {
        return async (req, res, next) => {
            try {
                ...
                const rootViewHtml = await liveviewjs.handleHttpLiveView(nanoid.nanoid, nanoid.nanoid, liveview, adaptor, this.pageRenderer, this.pageTitleDefaults, this.rootRenderer);
    ...
    wsRouter() {
        return new liveviewjs.WsMessageRouter(this.router, this.pubSub, this.flashAdapter, this.serDe, this.fileSystem, this.rootRenderer);
    }
}
/**
