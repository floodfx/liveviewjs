...
describe("test LiveViewSocket", () => {
  ...
  beforeEach(() => {
    ...
    socket = new WsLiveViewSocket<TestLVContext>("id", pageTitleCallback, pushEventCallback, pushPatchCallback, sendCallback, repeatCallback, subscribeCallback);
  })
  ...
  it("ws mount returns context", async () => {
    const socket = new WsLiveViewSocket<TestLVContext>("id", pageTitleCallback, pushEventCallback, pushPatchCallback, sendCallback, repeatCallback, subscribeCallback);
  ...
  it("calls all callbacks", async() => {
    ...
    const socket = new WsLiveViewSocket<TestLVPushAndSendContext>("id", pageTitleCallback, pushEventCallback, pushPatchCallback, sendCallback, repeatCallback, subscribeCallback);
    component.mount({_csrf_token:"csrf", _mounts: -1}, {}, socket);
