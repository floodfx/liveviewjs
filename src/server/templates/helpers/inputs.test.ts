...
describe("inputs helper", () => {
  ...
  it("returns basic text input with placeholder, autocomplete", () => {
    ...
    expect(result).toBe(`<input type="text" id="input_foo" name="foo" value="" autocomplete="off" placeholder="placeholder"/>`)
  });
  ...
  it("returns basic text input with placeholder, autocomplete, debounce", () => {
    ...
    expect(result).toBe(`<input type="text" id="input_foo" name="foo" value="" autocomplete="off" placeholder="placeholder" phx-debounce="blur"/>`)
  });
  ...
  it("returns text input with placeholder, autocomplete, debounce, type=tel", () => {
    ...
    expect(result).toBe(`<input type="tel" id="input_foo" name="foo" value="" autocomplete="off" placeholder="placeholder" phx-debounce="blur"/>`)
  });
